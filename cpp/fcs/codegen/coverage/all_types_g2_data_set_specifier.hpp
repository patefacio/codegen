/******************************************************************************
 * all_types_g2_data_set_specifier.hpp
 *
 ...
 *******************************************************************************/
/*! 
 * \file all_types_g2_data_set_specifier.hpp
 *
 * \brief Defines the location in the file and the data_set for writing
 * 
 */
#ifndef _FCS_CODEGEN_COVERAGE_ALL_TYPES_G2_DATA_SET_SPECIFIER_H_
#define _FCS_CODEGEN_COVERAGE_ALL_TYPES_G2_DATA_SET_SPECIFIER_H_
...
namespace coverage {
  ...
  class All_types_g2_data_set_specifier :
    public fcs::patterns::Singleton< All_types_g2_data_set_specifier > 
  {
  protected:

    All_types_g2_data_set_specifier() :
  ...
  private:
    ...
    friend class fcs::patterns::Singleton_impl< All_types_g2_data_set_specifier >;
  };

} // namespace coverage
} // namespace codegen
} // namespace fcs
#endif // _FCS_CODEGEN_COVERAGE_ALL_TYPES_G2_DATA_SET_SPECIFIER_H_
