...
classes = [
           ...
           CppClass.new({ 
                          ...
                          :enums => [ Enumeration.new(
                                      ...
                                      Enumeration.new(
                                                      {
                                                        :name => 'GooEnum', :values => ['a_xyz', 'b_xyz', 'c'],
                                                        :mask => true,
                                                        :pick_list_text_proc => proc {|x| x.gsub(/y/,'')}}),
                                    ],
                        }),
...
',
           ...
           CppClass.new(
                        { 
                          ...
                          :ctor_default => true,
                          :name => 'sample',
                          :header_filename => 'SaMpLe.hpp',
                          :impl_filename => 'SaMpLe.cpp',
                          :api_decl => 'SIMPLE_API',
                          :comparable => true,
                          :streamable => true,
                          :op_equal => true,
                          ...
                          #:boost_orable => true,
                          :brief => 'Test performance of implementation of operator<',
                          :impl_includes => ["#{$top}/utils/streamers/containers.hpp"],
           ...
           CppClass.new({ 
                          :members => [
                                       ...
                                       Member.new({ :cpp_type =>'NameMapMap', :name =>'nameMapMap', :pass_by_ref =>true, :access => Codegen::Access::RW}), 
                                       Member.new({ :cpp_type =>'sample', :name =>'embeddedSample', :pass_by_ref =>true, :access => Codegen::Access::RW}), 
                                      ],
                          :name => 'goo',
                          :streamable => true,
...
classes.each do |c|
#  c.header_path = "/home/someone/#{$top}/cpp/#{$top}/gooberdoo"
#  c.impl_path = "/home/someone/#{$top}/cpp/#{$top}/gooberdoo"
end

lib = Codegen::Cpp::Library.new({ 
                                  :name =>'sample',
                                  :api_decl => 'SAMPLE_API',
#                                  :cpp_path => Pathname.new("/home/someone/tmp/moo"),
                                  :jam_requirements => [ 
                                                        '/site-config//boost_serialization',
                                                        '$(PANTHEIOS_LIBS)'
                                                       ],
                                  :namespace => [$top, 'examples',],
                                  :classes => classes,
                                })
