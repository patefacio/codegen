...
app = Application.new(
                      { 
                        ...
                        [ 
                         ...
                         'fcs/sample/group/one_ring_dispatcher.hpp',
                         'fcs/sample/group/one_ring_dispatch.hpp',
                         'fcs/orm/code_metrics/block_tracker_orm.hpp',
                         'boost/foreach.hpp',
                         'algorithm',
                        ],
                        :jam_requirements => [ 
...
app = Application.new(
                      { 
                        ...
                        [ 
                         'fcs/utils/streamers/vector.hpp',
                         'fcs/sample/vgroup/one_ring_base.hpp',
                         'fcs/sample/vgroup/a_inl.hpp',
                         'fcs/sample/vgroup/b_inl.hpp',
                         'fcs/sample/vgroup/c_inl.hpp',
                         'fcs/orm/code_metrics/block_tracker_orm.hpp',
                         'boost/foreach.hpp',
                         'algorithm',
                        ],
